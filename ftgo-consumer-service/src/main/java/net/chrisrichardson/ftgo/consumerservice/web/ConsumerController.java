...
public class ConsumerController {
  ...
  public ResponseEntity<Void> validateOrderForConsumer(@PathVariable long consumerId,
    ...
    } catch (net.chrisrichardson.ftgo.consumerservice.api.ConsumerNotFoundException e) {
      return new ResponseEntity<>(HttpStatus.NOT_FOUND);
    } catch (net.chrisrichardson.ftgo.consumerservice.api.ConsumerVerificationFailedException e) {
