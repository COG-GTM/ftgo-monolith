...
public class ConsumerServiceTest {
  ...
  public void shouldCreateConsumer() {
    ...
    Consumer created = consumerService.create(name);

    assertNotNull(created);
    assertEquals("John", created.getName().getFirstName());
  ...
  public void shouldFindConsumerById() {
    ...
    Optional<Consumer> found = consumerService.findById(1L);

    assertTrue(found.isPresent());
    assertEquals("Jane", found.get().getName().getFirstName());
  }
  ...
  public void shouldReturnEmptyWhenNotFound() {
    ...
    Optional<Consumer> found = consumerService.findById(999L);
  ...
  public void shouldThrowWhenConsumerNotFoundOnValidate() {
    ...
    consumerService.validateOrderForConsumer(999L, new Money("100.00"));
  }
}
