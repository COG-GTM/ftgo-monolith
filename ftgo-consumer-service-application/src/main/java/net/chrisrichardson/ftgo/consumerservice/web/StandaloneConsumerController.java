...
import net.chrisrichardson.ftgo.consumerservice.domain.ConsumerEntity;
import net.chrisrichardson.ftgo.consumerservice.domain.StandaloneConsumerService;
...
public class StandaloneConsumerController {

  @Autowired
  private StandaloneConsumerService consumerService;
