...
public class CourierServiceConfiguration {
  ...
  @Bean
  public CourierAssignmentService courierAssignmentService(CourierRepository courierRepository,
                                                           CourierAssignmentStrategy courierAssignmentStrategy) {
    return new CourierAssignmentService(courierRepository, courierAssignmentStrategy);
  }
