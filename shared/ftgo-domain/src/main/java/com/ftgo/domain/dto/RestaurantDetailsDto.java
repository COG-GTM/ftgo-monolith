...
/**
 * Restaurant summary DTO for cross-service communication.
 * Replaces direct Restaurant entity sharing between services.
 */
public class RestaurantDetailsDto {
    ...
    public RestaurantDetailsDto(Long restaurantId, String name, String street1, String street2,
