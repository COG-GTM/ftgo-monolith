...
|-------|----------|---------|-------|----------------|---------|---------------|
| 1 | EM-30 | Define Microservices Repository Structure and Naming Conventions | Phase 1 | Complete | [PR #27](https://github.com/COG-GTM/ftgo-monolith/pull/27) | Success |
